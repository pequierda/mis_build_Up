    ...
    return `
        <div class="service-card bg-white rounded-xl shadow-lg p-8 border border-gray-100">
            ...
            <div class="border-t pt-4">
                <button onclick="bookService('${service.id}', '${service.title}')" class="w-full bg-red-600 hover:bg-red-700 text-white py-3 px-6 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
                    Book Me
                </button>
            </div>
        </div>
